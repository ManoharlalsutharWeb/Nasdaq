...
const AGGREGATOR = (function(){
  function ref(name){
    const M={NATAL,DASHA,TRANSITS,EVENTS,VARGA,SESSIONS,REGIME,SCORING,TYPES,CONFIG};
  ...
  return{collectAll,buildDaily,buildSessions,buildNYOpen,
