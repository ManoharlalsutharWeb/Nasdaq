...
const TRANSITS = (function(){
  ...
  function n180(a){ const N=require?require('./natal').n180:NATAL.n180; return N(a); }
  ...
  function buildReport(dateIST,natal_d1){
    const N=getNatal();
    ...
    const TNAK=typeof TYPES!=='undefined'?TYPES:require('./types');
