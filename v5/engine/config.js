...
const CONFIG = {
  ...
  REQUIRED_PAGES: [
    ...
    "app/alerts.html","app/vargas.html","app/research.html",
  ...
  REQUIRED_MODULES: [
    ...
    "engine/regime.js","engine/scoring.js","engine/aggregator.js","engine/research.js",
    "engine/verifier.js"
  ],
  ...
  // Kundali-first weights (total = 1.0); Hora is contextual only, not a driver.
  WEIGHTS: {
    kundali:  0.75,   // D1 twelve houses + D1-D60 + dasha
    transits: 0.20,   // transit exactness windows
    panchang: 0.05,   // tithi/nakshatra/yoga as context
    other:    0.00,   // optional confirmation only
  },
