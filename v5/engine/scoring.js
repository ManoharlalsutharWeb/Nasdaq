/* ============================================================
   ...
   Weights: Kundali 75% | Transits 20% | Panchang 5% | Other 0%
   ============================================================ */
'use strict';
...
const SCORING = (function(){
  ...
  const DEFAULT_WEIGHTS={
    kundali:  0.75,  // D1 twelve houses + D1-D60 + dasha context
    transits: 0.20,  // transit exactness
    panchang: 0.05,  // tithi/nakshatra/yoga context only
